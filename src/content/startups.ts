...
export const startups: Startup[] = [
  {
    ...
    traction: [
      { label: "Stories shipped", value: "219 / 225", note: "97.3% of a 24-module backlog, per the live tracker" },
      { label: "Modules complete", value: "20 of 24", note: "Smart Notifications finished this cycle; voice, WhatsApp and payments are code-complete and pending account/provider activation" },
      { label: "Notification center", value: "Live in-app", note: "Feed, snooze, escalation and behaviour-learned timing — fully shipped, no account to open" },
      { label: "Billing infrastructure", value: "Razorpay + Stripe", note: "Real prices seeded (Pro ₹299, Max ₹599); checkout and webhooks code-complete, pending provider key activation" },
    ],
    roadmap: [
      { horizon: "Now", items: ["Turn on WhatsApp, Alexa and Gemini voice as each account is connected", "Voice evaluation, metrics and release gates", "Finish the translation catalog, multi-currency records and right-to-left support"] },
      { horizon: "Next", items: ["Activate payments (Razorpay/Stripe) as plans go live", "Public API and developer platform", "Payment operations: refunds, reconciliation and monitoring"] },
      { horizon: "Later", items: ["Quota automation and plan experiments", "Regional expansion beyond India"] },
    ],
  ...
  },
  {
    ...
    hero: {
      ...
      sub: "Tell Wonder what you're looking for, in your own words. It searches real sources, explains every match and prepares your applications — you make the final call, and it never applies on anyone's behalf.",
    },
    problem: {
