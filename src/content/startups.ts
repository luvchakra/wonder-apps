...
export const startups: Startup[] = [
  {
    ...
    screens: [
      { src: "/screenshots/wonderhome/home-desktop.png", alt: "WonderHome landing page on desktop showing the hero 'A calmer home is possible' and a household dashboard preview", kind: "desktop", caption: "The product site — same design language as the app" },
      { src: "/screenshots/wonderhome/home-mobile.png", alt: "WonderHome on a phone, showing the mobile hero and Today view", kind: "mobile", caption: "Installs like an app on iPhone and Android" },
      { src: "/screenshots/wonderhome/features-desktop.png", alt: "WonderHome features section listing the household domains", kind: "desktop", caption: "Every feature is a household outcome" },
      { src: "/screenshots/wonderhome/pricing-mobile.png", alt: "WonderHome plans on a phone: Free, Pro and Max", kind: "mobile", caption: "Three plans, from a quiet watcher to a home that runs itself" },
      { src: "/screenshots/wonderhome/security-desktop.png", alt: "WonderHome security section: private by default, tenant isolation, child privacy, governed AI", kind: "desktop", caption: "Private by default — security as a family feature" },
    ],
    market: {
  ...
  },
  {
    ...
    logo: { light: "/brands/wonderjobs/wonderjobs-logo-light.png", dark: "/brands/wonderjobs/wonderjobs-logo-dark.png", mark: "/brands/wonderjobs/wonder-mark.png" },
    hero: {
    ...
    screens: [
      { src: "/screenshots/wonderjobs/home-desktop.png", alt: "WonderJobs landing page on desktop with the parallax hero and live run preview", kind: "desktop", caption: "Scroll-linked hero on the product site" },
      { src: "/screenshots/wonderjobs/jobs-desktop.png", alt: "WonderJobs jobs list in demo mode with Wonder Fit labels and filters", kind: "desktop", caption: "Jobs view — every match explains itself" },
      { src: "/screenshots/wonderjobs/runs-mobile.png", alt: "WonderJobs Wonder Runs screen on a phone showing stage-by-stage progress", kind: "mobile", caption: "A run's live stages on mobile" },
      { src: "/screenshots/wonderjobs/applications-desktop.png", alt: "WonderJobs applications dashboard with status tabs and timeline", kind: "desktop", caption: "Applications tracker" },
      { src: "/screenshots/wonderjobs/career-dna-mobile.png", alt: "WonderJobs Career DNA profile on a phone", kind: "mobile", caption: "Career DNA — the profile every score is measured against" },
      { src: "/screenshots/wonderjobs/home-mobile.png", alt: "WonderJobs landing on a phone", kind: "mobile", caption: "Installable PWA" },
      { src: "/screenshots/wonderjobs/how-it-works-desktop.png", alt: "WonderJobs how-it-works section: Search, Analyse, Prepare, Track", kind: "desktop", caption: "Search · Analyse · Prepare · Track" },
      { src: "/screenshots/wonderjobs/insights-desktop.png", alt: "WonderJobs insights view in demo mode", kind: "desktop", caption: "Insights derived from real runs and applications" },
      { src: "/screenshots/wonderjobs/ai-mobile.png", alt: "WonderJobs AI provider section on a phone: WonderJobs AI or bring your own Anthropic, OpenAI or Gemini key", kind: "mobile", caption: "Your AI, your keys" },
    ],
    market: {
  ...
  },
  {
    ...
    screens: [
      { src: "/screenshots/wonderark/home-desktop.png", alt: "WonderArk landing page on desktop showing the five modules on one data model", kind: "desktop", caption: "The five modules on one shared data model" },
      { src: "/screenshots/wonderark/home-mobile.png", alt: "WonderArk landing on a phone", kind: "mobile", caption: "Responsive across devices" },
      { src: "/screenshots/wonderark/modules-desktop.png", alt: "WonderArk module detail section for Discovery, Inventory, Service, CRM and Finance", kind: "desktop", caption: "Module detail — independently licensable" },
      { src: "/screenshots/wonderark/pricing-mobile.png", alt: "WonderArk pricing tiers on a phone", kind: "mobile", caption: "Free, Pro and Max" },
      { src: "/screenshots/wonderark/how-it-works-desktop.png", alt: "WonderArk how-it-works: create the business once, license modules independently, data connects automatically", kind: "desktop", caption: "License what you need; add modules in place" },
    ],
    market: {
  ...
  },
  {
    ...
    logo: { light: "/brands/wonderagent/wonderagent-wordmark-light.png", dark: "/brands/wonderagent/wonderagent-wordmark-dark.png", mark: "/brands/wonderagent/wonderagent-mark.png" },
    hero: {
    ...
    screens: [
      { src: "/screenshots/wonderagent/overview-desktop-light.png", alt: "WonderAgent overview dashboard for a tenant: agent counts, risk by severity, action queue and recent findings", kind: "desktop", caption: "Tenant overview — counts, risk by severity, action queue" },
      { src: "/screenshots/wonderagent/overview-mobile-light.png", alt: "WonderAgent overview on a phone with metric cards stacked two across", kind: "mobile", caption: "The same overview on a phone" },
      { src: "/screenshots/wonderagent/risk-desktop-dark.png", alt: "WonderAgent Risk screen listing agents with open findings, worst severity first", kind: "desktop", caption: "Risks & Alerts — worst severity first" },
      { src: "/screenshots/wonderagent/agents-desktop-light.png", alt: "WonderAgent AI agents inventory with lifecycle state, criticality and owner", kind: "desktop", caption: "The agent inventory — owner, lifecycle, criticality" },
      { src: "/screenshots/wonderagent/home-mobile.png", alt: "WonderAgent product site on a phone", kind: "mobile", caption: "Product site on mobile" },
      { src: "/screenshots/wonderagent/model-desktop.png", alt: "WonderAgent SHOULD, CAN and DID model explained on the product site", kind: "desktop", caption: "SHOULD · CAN · DID — the governance model" },
      { src: "/screenshots/wonderagent/product-mobile.png", alt: "WonderAgent product capabilities on a phone", kind: "mobile", caption: "Capabilities, on mobile" },
      { src: "/screenshots/wonderagent/agents-desktop-dark.png", alt: "WonderAgent agent inventory in dark mode", kind: "desktop", caption: "Agent inventory, dark theme" },
    ],
    market: {
